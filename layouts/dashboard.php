...
<head>
    ...
    <title>Tugas 2 - Dea Lestari</title>
</head>
...
<body>
    <div class="template-nur">
        <div class="sidebar">
            <div class="logo">UINSU</div>
        ...
        <div class="content">
            <nav class="top-bar">
                <div>Tugas PWD | Dea Lestari - 0702193196</div>
            </nav>
            ...
            <footer>
                <div class="container">
                    &copy; Copyright Dea Lestari | Tugas 2 PWD
                </div>
            </footer>
        </div>
    </div>
